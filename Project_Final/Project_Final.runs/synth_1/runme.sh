...
HD_PWD='C:/Users/hasan/Desktop/TOBB CS Hasan TUNA/21-22/SUMMER/BIL265/Project/Project_Final/Project_Final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kontrolcu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kontrolcu.tcl
