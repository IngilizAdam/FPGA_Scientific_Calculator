...
HD_PWD='C:/Users/hasan/Desktop/TOBB CS Hasan TUNA/21-22/SUMMER/BIL265/Project/Project_Final/Project_Final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kontrolcu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kontrolcu.tcl -notrace
